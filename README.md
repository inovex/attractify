...
```
curl -o docker-compose.yml https://raw.githubusercontent.com/inovex/attractify/9fac8c7ad566333cf60977eb83842dfb34a343e5/docker-compose.yml\?token\=ANOALAEJ54ZV6B43KJXMFNTBSOJXE | docker-compose up
```
