        ...
        <v-card>
          ...
          <v-card-text>
            <v-row>
              ...
              <v-col>
                <v-btn @click="createToken" :disabled="channel === ''" rounded color="primary" style="color: var(--v-buttontext-base)">Create Token</v-btn>
              </v-col>
            </v-row>
            <v-row>
              <v-col>
          ...
          <v-card-text>
            ...
            <v-row>
              ...
              <v-col>
                <v-btn @click="showKey()" rounded color="primary" style="color: var(--v-buttontext-base)">Show Signature Key</v-btn>
              </v-col>
            </v-row>
            <v-row>
              <v-col>
          ...
          <v-card-text>
            ...
            <v-row>
              <v-col>
                <v-btn @click="getToken()" rounded color="primary" style="color: var(--v-buttontext-base)">Generate Token</v-btn>
              </v-col>
            </v-row>
            <v-row>
              <v-col>
